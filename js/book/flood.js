 ...
 *           昼夜轮转，只有方舟窗里一点灯。
 *   8:1–5   「神记念挪亚」——风吹过水面，雨止，云开处透下光；亚拉腊山自水中现出（大、小两峰），
...
(function (GS) {
  ...
  GS.book.act({
    ...
    behold: {
      ...
      '挪亚的妻子': { text: '挪亚就同他的妻和儿子儿妇都进入方舟，躲避洪水。', ref: '创世记 7:7' },
      ...
      '闪的妻子': { text: '挪亚就同他的妻和儿子儿妇都进入方舟，躲避洪水。', ref: '创世记 7:7' },
      '含的妻子': { text: '挪亚就同他的妻和儿子儿妇都进入方舟，躲避洪水。', ref: '创世记 7:7' },
      '雅弗的妻子': { text: '挪亚就同他的妻和儿子儿妇都进入方舟，躲避洪水。', ref: '创世记 7:7' },
    ...
    stages: [
      ...
      // ── 6:13–22 方舟 ────────────────────────────────────────
      {
        ...
        verse: [
          ...
          { text: '你要用歌斐木造一只方舟，分一间一间地造，<br>里外抹上松香。', ref: '创世记 6:14', hold: 6.5 },
      ...
      // ── 6:19–20 · 7:8–9 一对一对 ───────────────────────────
      {
        ...
        verse: [
          ...
          { text: '洁净的畜类和不洁净的畜类，飞鸟并地上一切的昆虫，<br>都是一对一对地，有公有母，<br>到挪亚那里进入方舟，正如神所吩咐挪亚的。', ref: '创世记 7:8–9', hold: 9 },
        ],
        apply(c) {
      ...
      // ── 7:1–7 全家进入方舟 ─────────────────────────────────
      {
        ...
        verse: [
          ...
          { text: '挪亚就同他的妻和儿子儿妇都进入方舟，躲避洪水。', ref: '创世记 7:7', hold: 6.5 },
        ],
        apply(c) {
      ...
      // ── 7:15–16 门关上了 ────────────────────────────────────
      {
        ...
        verse: [
          { text: '凡有血肉、有气息的活物，都一对一对地到挪亚那里，进入方舟。<br>凡有血肉进入方舟的，都是有公有母，正如神所吩咐挪亚的。<br>耶和华就把他关在方舟里头。', ref: '创世记 7:15–16', hold: 10 },
        ],
        apply(c) {
          TL(c, [
            [0, b => {
      ...
      // ── 7:4 · 7:10–12 四十昼夜的雨 ─────────────────────────
      {
        ...
        verse: [
          { text: '过了那七天，洪水氾滥在地上。<br>当挪亚六百岁，二月十七日那一天，<br>大渊的泉源都裂开了，天上的窗户也敞开了，', ref: '创世记 7:10–11', hold: 9 },
      ...
      // ── 7:17–24 水往上长 ────────────────────────────────────
      {
        ...
        verse: [
          { text: '洪水氾滥在地上四十天，水往上长，把方舟从地上漂起。', ref: '创世记 7:17', hold: 6.5 },
      ...
      // ── 8:1–5 神记念挪亚 ───────────────────────────────────
      {
        kind: 'act', utter: '神记念挪亚', cmd: 'remember 挪亚 && wind.blow(地)', ref: '8:1', hold: 2.4,
        verse: [
          { text: '神记念挪亚和挪亚方舟里的一切走兽牲畜。<br>神叫风吹地，水势渐落。', ref: '创世记 8:1', hold: 7 },
      ...
      // ── 8:21–22 · 9:1 永不停息 ─────────────────────────────
      {
        ...
        verse: [
          { text: '耶和华闻那馨香之气，就心里说：<br>「我不再因人的缘故咒诅地（人从小时心里怀着恶念），<br>也不再按着我才行的灭各种的活物了。', ref: '创世记 8:21', hold: 9.5 },
      ...
      // ── 9:8–17 虹 ───────────────────────────────────────────
      {
        ...
        verse: [
          { text: '神说：「我与你们并你们这里的各样活物所立的永约是有记号的。<br>我把虹放在云彩中，这就可作我与地立约的记号了。', ref: '创世记 9:12–13', hold: 8 },
          { text: '我使云彩盖地的时候，必有虹现在云彩中，<br>我便记念我与你们和各样有血肉的活物所立的约，<br>水就再不氾滥、毁坏一切有血肉的物了。', ref: '创世记 9:14–15', hold: 9 },
          { text: '虹必现在云彩中，我看见，<br>就要记念我与地上各样有血肉的活物所立的永约。」', ref: '创世记 9:16', hold: 6.5 },
          { text: '神对挪亚说：「这就是我与地上一切有血肉之物立约的记号了。」', ref: '创世记 9:17', hold: 6.5 },
        ],
        apply(c) {
          TL(c, [
            [0, b => {
