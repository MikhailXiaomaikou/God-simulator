...
(function (GS) {
  ...
  const V3 = [
    ...
    { text: '流便听见了，要救他脱离他们的手，说：「我们不可害他的性命。」<br>又说：「不可流他的血，可以把他丢在这野地的坑里，不可下手害他。」', ref: '创世记 37:21–22', hold: 7.5 },
  ...
  const V4 = [
    ...
    { text: '雅各便撕裂衣服，腰间围上麻布，为他儿子悲哀了多日……<br>说：「我必悲哀着下阴间到我儿子那里。」约瑟的父亲就为他哀哭。', ref: '创世记 37:34–35', hold: 8 },
    { text: '那时，犹大离开他弟兄下去……<br>犹大承认说：「她比我更有义……」', ref: '创世记 38:1、26', hold: 6 },
    { text: '约瑟被带下埃及去。有一个埃及人，是法老的内臣——护卫长波提乏，<br>从那些带下他来的以实玛利人手下买了他去。', ref: '创世记 39:1', hold: 7.5 },
  ];
  const V5 = [
  ...
  const V12 = [
    { text: '埃及地的七个丰年一完，七个荒年就来了，正如约瑟所说的。<br>各地都有饥荒，惟独埃及全地有粮食。', ref: '创世记 41:53–54', hold: 7.5 },
  ...
  const V16 = [
    { text: '家宰就搜查，从年长的起，到年幼的为止，那杯竟在便雅悯的口袋里搜出来。', ref: '创世记 44:12', hold: 6.5 },
  ...
  const V23 = [
    { text: '雅各嘱咐众子已毕，就把脚收在床上，气绝而死，归到列祖那里去了。', ref: '创世记 49:33', hold: 7 },
  ...
  GS.book.act({
    ...
    behold: {
      ...
      '流便': { text: '流便听见了，要救他脱离他们的手，说：「我们不可害他的性命。」', ref: '创世记 37:21' },
