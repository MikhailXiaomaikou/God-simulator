...
(function (GS) {
  ...
  const ACT = 'proverbs';
  GS.book.act({
    id: ACT, book: '箴言', books: [20], title: '智慧', sub: '箴言 1 — 31', tint: [240, 236, 200], music: 'eden',
    outro: 8,
    setup() {
    ...
    stages: [
      {
        kind: 'act', utter: '耶和华以智慧立地，以聪明定天', cmd: 'echo "智慧"', ref: '3:19',
        verse: [{ text: '耶和华以智慧立地，以聪明定天，', ref: '箴言 3:19', hold: 7 }],
