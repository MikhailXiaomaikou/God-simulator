...
(function (GS) {
  ...
  function setup() {
    ...
    S.twins = 1;
    avoid([0.49, 0.64]);
    // 地上本有的：庇耳‧拉海‧莱的水泉（雅博河到 32 章才显出来）
    prop('spring', 'well', { x: X.spring, label: '庇耳‧拉海‧莱' });
  ...
  const V10 = [
    ...
    { text: '利亚怀孕生子，就给他起名叫吕便，因而说：<br>「耶和华看见我的苦情，如今我的丈夫必爱我。」', ref: '创世记 29:32', hold: 6.5 },
  ...
  const V19 = [
    ...
    { text: '雅各从巴旦‧亚兰回来的时候，平平安安地到了迦南地的示剑城，在城东支搭帐棚……<br>在那里筑了一座坛。', ref: '创世记 33:18–20', hold: 7 },
  ...
  const V20 = [
    ...
    { text: '他在那里筑了一座坛，就给那地方起名叫伊勒‧伯特利；<br>因为他逃避他哥哥的时候，神在那里向他显现。', ref: '创世记 35:7', hold: 7 },
  ];
  ...
  const V21 = [
    ...
    { text: '她将近于死，灵魂要走的时候，就给她儿子起名叫便‧俄尼；<br>他父亲却给他起名叫便雅悯。', ref: '创世记 35:18', hold: 7 },
  ...
  const STAGES = [
    ...
    // ── 10 · 耶和华见利亚失宠：吕便、西缅、利未、犹大 ─────────────
    {
      kind: 'act', utter: '耶和华见利亚失宠，就使她生育', cmd: 'spawn 吕便 西缅 利未 犹大  # 神看见', ref: '29:31',
      verse: V10,
      apply(c) {
        const L = starts(V10);
        T(c, [
          ...
          [L[1] + 0.8, b => birth(b, 'reuben', '吕便', 'leah')],
      ...
      apply(c) {
        ...
        beats.push(
          ...
          [L[2], b => {
            ...
            prop('altarS', 'altar', { x: X.altarS, grow: 1, label: '伊利‧伊罗伊‧以色列' });
    ...
    // ── 20 · 起来！上伯特利去 ───────────────────────────────
    {
      ...
      apply(c) {
        ...
        T(c, [
          ...
          [L[3] + 1, b => { prop('altarB', 'altar', { x: X.altarB, grow: 1, label: '伊勒‧伯特利' }); prop('stone', null, { lit: 0.5 }); walk('jacob', X.altarB + 0.012, { speed: 0.02 }); sfx(b, 'build'); }],
  ...
  GS.book.act({
    ...
    behold: {
      ...
      '便雅悯': { text: '她将近于死，灵魂要走的时候，就给她儿子起名叫便‧俄尼；<br>他父亲却给他起名叫便雅悯。', ref: '创世记 35:18' },
