...
(function (GS) {
  ...
  const V2 = [
    ...
    { text: '二人还没有躺卧，女人就上房顶，到他们那里，<br>对他们说：「我知道耶和华已经把这地赐给你们……<br>耶和华你们的神本是上天下地的神。」', ref: '约书亚记 2:8–11', hold: 7 },
  ...
  const V5 = [
    { text: '耶和华对约书亚说：<br>「我今日将埃及的羞辱从你们身上滚去了。」<br>因此，那地方名叫吉甲，直到今日。<br>以色列人在吉甲安营……在耶利哥的平原守逾越节。', ref: '约书亚记 5:9–10', hold: 7 },
  ...
  const V10 = [
    { text: '这些王和他们的众军都出来，<br>人数多如海边的沙，并有许多马匹车辆……<br>耶和华对约书亚说：「你不要因他们惧怕……<br>你要……用火焚烧他们的车辆。」', ref: '约书亚记 11:4–6', hold: 7.5 },
  ...
  const V13 = [
    { text: '这样，耶和华将从前向他们列祖<br>起誓所应许的全地赐给以色列人……<br>耶和华应许赐福给以色列家的话<br>一句也没有落空，都应验了。', ref: '约书亚记 21:43–45', hold: 6.5 },
  ...
  const V14 = [
    { text: '『我赐给你们地土，非你们所修治的；<br>我赐给你们城邑，非你们所建造的……』<br>「……今日就可以选择所要事奉的……<br>至于我和我家，我们必定事奉耶和华。」', ref: '约书亚记 24:13–15', hold: 7.5 },
    ...
    // ── 5 · 我今日将埃及的羞辱从你们身上滚去了（5:1–15）── 逾越节、吗哪止住、耶和华军队的元帅 ──
    {
      ...
      apply(c) {
        ...
        T(c, [
          ...
          // 「我今日将埃及的羞辱从你们身上滚去了」——那地方名叫吉甲（5:9）
          [1.6, b => {
            const p = getP('stones'), x = X.tentW[1] * W.w, y = (p ? baseOf(p) : gY(2, X.tentW[1])) - PH(2) * 1.9;
            ringAt(b, x, y + PH(2) * 1.2, [255, 230, 190], M() * 0.2, 2.4);
            nameHere(b, '吉甲', x, y, [255, 230, 190], { size: 0.04, hold: 3.4 });
