 ...
 *                 · 小先知书·慈绳爱索（何西阿书 — 弥迦书）
 *
 * 写法见 js/music/ot1.js 的开头（仍全在 A 上；响度照那里的规矩：每组增益之和约 1.0–1.4，根音 0.35–0.5，高声部 0.01–0.15；较暗、较低的组已按离线测得的 A 计权响度补足到与 ot1 同一水平）。
 * 本文件另有几件小工具，绕过登记表的局限：
...
(function (GS) {
  ...
  const snMix = lv => {
    ...
    const vision = cl(max(lv('snPave'), lv('snPattern'), n === 9 ? 0.85 * lv('snGems') : 0, n === 6 ? 0.35 : 0));   // 使者在路上：一点微光；宝石只在胸牌那一句（此后 snGems 一直留着）
    ...
    const name = cl(max((n === 12 ? 1 : 0.4) * lv('snName'), (n === 12 ? 0.75 : 0.3) * lv('snShine')));   // 名与面光说过之后仍留着：之后只余一点
  ...
  music('sinai', {
    ...
    pad: { lp: 1300, groups: {
      ...
      horn: [['A2', 's', 0.494, 0], [165, 'warm', 0.26, -0.15], [220, 'warm', 0.195, 0.2], [275, 'warm', 0.13, -0.3], [330, 'warm', 0.104, 0.35], [385, 's', 0.052, -0.4], [440, 's', 0.039, 0.45]],
      law: [['A1', 's', 0.34, 0], ['E2', 'soft', 0.28, 0.1], ['A2', 'over', 0.08, 0], ['B2', 'soft', 0.16, -0.25], ['Fs3', 'soft', 0.12, 0.3], ['Cs4', 's', 0.07, -0.4]],
      vision: [['A2', 's', 0.403, 0], ['E3', 'soft', 0.297, -0.15], ['B3', 's', 0.148, 0.3], ['Ds4', 's', 0.074, -0.35], ['Gs4', 's', 0.064, 0.4], ['Cs5', 's', 0.037, -0.45], ['Fs5', 's', 0.016, 0.5]],
      ...
      cleft: [['A1', 's', 0.5, 0], ['E2', 'soft', 0.36, 0.1], ['B2', 'soft', 0.144, -0.25], ['E3', 's', 0.096, 0.3]],
      name: [['A2', 's', 0.42, 0], ['E3', 'soft', 0.18, 0.15], ['A3', 'choir', 0.18, 0], ['Cs4', 'choir', 0.15, 0], ['E4', 'choir', 0.12, 0], ['Fs4', 'choir', 0.1, 0], ['B4', 's', 0.03, -0.45]],
      craft: { v: [['A2', 's', 0.5, 0], ['E3', 'soft', 0.333, -0.2], ['A3', 'soft', 0.155, 0.25], ['Cs4', 't', 0.119, -0.3], ['E4', 'harp', 0.071, 0.35], ['Fs4', 's', 0.048, -0.45]], pulse: [1.6, 0.22] },
  ...
  music('joshua', {
    ...
    pad: { lp: 1400, groups: {
      ...
      promise: [['A2', 's', 0.424, 0], ['E3', 'soft', 0.276, -0.15], ['A3', 'soft', 0.159, 0.25], ['Cs4', 'flute', 0.138, -0.3], ['E4', 's', 0.095, 0.35], ['B4', 's', 0.042, -0.45], ['Fs5', 's', 0.013, 0.5]],
      river: { v: [['A1', 's', 0.39, 0], ['A2', 's', 0.26, 0], ['E3', 'soft', 0.338, -0.2], ['B3', 's', 0.156, 0.3], ['D4', 'soft', 0.13, -0.3], ['E4', 's', 0.091, 0.4], ['A4', 's', 0.039, -0.45]], pulse: [0.26, 0.3] },
      still: { v: [['A2', 's', 0.418, 0], ['E3', 'soft', 0.286, -0.15], ['A3', 'over', 0.066, 0.1], ['B3', 's', 0.132, 0.3], ['E4', 's', 0.099, -0.35], ['Fs4', 's', 0.055, 0.4], ['B4', 's', 0.039, -0.45], ['E5', 's', 0.02, 0.5]], breath: 0.003 },
      march: { v: [['A1', 's', 0.5, 0], ['E2', 'soft', 0.432, 0.1], ['A2', 'reed', 0.054, -0.2], ['D3', 'soft', 0.216, -0.3], ['E3', 'soft', 0.135, 0.3], ['G3', 's', 0.068, 0.4]], pulse: [0.62, 0.45] },
      siege7: { v: [['A1', 's', 0.5, 0], ['E2', 'soft', 0.369, 0.1], ['Bb2', 'soft', 0.086, -0.35], ['D3', 'soft', 0.197, 0.3], ['G3', 'soft', 0.111, -0.25], ['C4', 's', 0.049, 0.4]], pulse: [1.15, 0.45] },
      horn: [['A1', 's', 0.368, 0], ['A2', 's', 0.253, 0], [165, 'reed', 0.081, -0.25], [220, 'warm', 0.184, 0.2], [330, 'warm', 0.115, -0.3], [440, 's', 0.057, 0.35], [385, 's', 0.029, -0.4]],
      war: [['A1', 's', 0.5, 0], ['E2', 'soft', 0.339, 0.1], ['A2', 'warm', 0.064, -0.15], ['C3', 'soft', 0.233, -0.3], ['E3', 'soft', 0.106, 0.25], ['Bb3', 's', 0.048, 0.35]],
      land: [['A2', 's', 0.462, 0], ['E3', 'soft', 0.308, -0.2], ['A3', 'soft', 0.132, 0.25], ['Cs4', 't', 0.11, -0.3], ['E4', 'soft', 0.099, 0.35], ['Fs4', 's', 0.044, 0.45], ['A4', 'flute', 0.055, -0.4]],
    } },
    mix: joMix,
  ...
  const kdMix = lv => {
    ...
    const dark = (n === 14 ? 0.3 : 1) * cl(max(sm(0.1, 0.38, gloom), lv('dkPlague'), 0.6 * lv('dkCount'), n === 12 ? 0.55 * sm(0.3, 0.8, storm) : 0,
    ...
    const mercy = cl(max(n === 7 ? max(lv('dkBeam'), 0.75 * (1 - sm(0.02, 0.2, gloom))) : 0, rainK,             // 「耶和华已经除掉你的罪」·耶底底亚
      n === 14 ? max(0.55, lv('dkAltar'), lv('dkFire')) : 0, n === 5 ? 0.6 * lv('dkTable') : 0));                   // 「够了！住手吧！」
  ...
  music('kingdavid', {
    ...
    pad: { lp: 1300, groups: {
      ...
      crown: [['A2', 's', 0.5, 0], ['A2', 'over', 0.081, 0], ['E3', 'soft', 0.378, -0.2], ['A3', 'warm', 0.108, 0.2], ['Cs4', 'soft', 0.189, -0.3], ['E4', 's', 0.108, 0.35], ['B4', 's', 0.041, -0.45]],
      dance: { v: [['A2', 's', 0.5, 0], ['E3', 'soft', 0.33, -0.15], ['A3', 't', 0.127, 0.25], ['Cs4', 'soft', 0.152, -0.3], ['E4', 't', 0.076, 0.35], ['G4', 's', 0.044, -0.45]], pulse: [2.1, 0.35] },
      house: [['A2', 's', 0.5, 0], ['E3', 'soft', 0.254, 0.15], ['Cs4', 'choir', 0.165, 0], ['E4', 'choir', 0.14, 0], ['Gs4', 'choir', 0.114, 0], ['B4', 'choir', 0.089, 0], ['Ds5', 's', 0.019, -0.5]],
      dusk: [['A2', 's', 0.483, 0], ['E3', 'soft', 0.31, -0.2], ['G3', 'soft', 0.138, 0.3], ['B3', 'soft', 0.115, -0.3], ['D4', 's', 0.069, 0.35], ['Fs4', 's', 0.034, -0.45]],
      dark: { v: [['A1', 's', 0.5, 0], ['E2', 'soft', 0.371, 0.1], ['Bb2', 'soft', 0.093, -0.35], ['C3', 'soft', 0.255, 0.3], ['F3', 's', 0.07, -0.3]], pulse: [0.75, 0.22] },
      mercy: [['A2', 's', 0.5, 0], ['E3', 'soft', 0.381, -0.15], ['B3', 'flute', 0.127, 0.3], ['Cs4', 'soft', 0.165, -0.3], ['Fs4', 's', 0.064, 0.4], ['A4', 's', 0.032, -0.45]],
      rock: [['A1', 's', 0.428, 0], ['E2', 'soft', 0.3, 0.1], ['A2', 'over', 0.086, -0.1], ['E3', 'soft', 0.171, 0.25], ['B3', 's', 0.075, -0.3], ['E4', 's', 0.043, 0.4]],
      dew: [['A2', 's', 0.424, 0], ['E3', 'soft', 0.276, -0.2], ['B3', 's', 0.127, 0.3], ['E4', 's', 0.085, -0.35], ['Fs4', 's', 0.064, 0.4], ['Cs5', 's', 0.032, -0.45], ['Gs5', 's', 0.011, 0.5]],
    } },
    mix: kdMix,
  ...
  const exMix = lv => {
    ...
    const lamp = cl(n === 3 ? 0.6 * (1 - lv('exSiege')) : n === 11 ? 0.8 * lv('exPass') : n === 12 ? 0.3 * sm(0.5, 0.25, lv('exLamp'))
  ...
  music('exile', {
    ...
    pad: { lp: 1300, groups: {
      ...
      siege: { v: [['A1', 's', 0.5, 0], ['E2', 'soft', 0.352, 0.1], ['Bb2', 'soft', 0.088, -0.35], ['D3', 'soft', 0.176, 0.3], ['F3', 's', 0.066, -0.3]], pulse: [0.7, 0.3] },
      idol: [['A1', 's', 0.5, 0], ['E2', 'soft', 0.351, 0.1], ['A2', 'reed', 0.068, -0.2], ['Cs3', 'soft', 0.216, 0.3], ['G3', 's', 0.068, -0.3], ['Bb3', 's', 0.061, 0.4]],
      faith: [['A2', 's', 0.5, 0], ['E3', 'soft', 0.378, -0.2], ['A3', 'over', 0.081, 0.1], ['Cs4', 'soft', 0.203, -0.3], ['E4', 's', 0.108, 0.35], ['A4', 's', 0.054, -0.45]],
  ...
  const ybMix = lv => {
    ...
    const bless = cl(n >= 14 ? lv('ybBless') / 0.5 : lv('ybBless'));                // 末了 ybBless 落到 0.55：福仍满
    const hope = cl(max(n === 3 ? 0.35 : 0, n === 6 ? max(0.25 * lv('ybFire'), 0.6 * lv('ybSprout'), 0.8 * lv('ybCarve')) : 0,   // 发芽与刻在磐石上的字此后一直留着
      lv('ybStand'), 0.8 * lv('ybGold'), lv('ybSeen'), n === 14 ? 0.7 * lv('ybAltar') : 0));                                     // 约伯为朋友祈祷
    ...
    const whirl = cl(n >= 8 && n <= 12 ? lv('ybWhirl') : 0.45 * lv('ybWhirl'));      // 耶和华从旋风中回答：旋风是一切言语的底
  ...
  music('job', {
    weight: { drone: 0.6, pad: 0.95 },
    pad: { lp: 1300, groups: {
      uz: [['A2', 's', 0.5, 0], ['E3', 'soft', 0.378, -0.2], ['A3', 'harp', 0.081, 0.2], ['Cs4', 'soft', 0.189, -0.3], ['E4', 's', 0.095, 0.35], ['Fs4', 's', 0.054, -0.45]],
      council: [['A2', 's', 0.38, 0], ['E3', 's', 0.16, 0.15], ['Bb2', 'soft', 0.05, -0.4], ['E4', 'choir', 0.14, 0], ['A4', 'choir', 0.11, 0], ['B4', 'choir', 0.08, 0], ['E5', 's', 0.02, 0.45]],
      loss: { v: [['A1', 's', 0.5, 0], ['E2', 'soft', 0.358, 0.1], ['C3', 'soft', 0.224, -0.3], ['Ds3', 's', 0.045, 0.35], ['F3', 's', 0.056, -0.35]], pulse: [1.25, 0.3] },
      ash: [['A1', 's', 0.5, 0], ['E2', 's', 0.36, 0.1], ['A2', 'soft', 0.144, -0.2], ['E3', 's', 0.072, 0.25]],
      hope: [['A2', 's', 0.42, 0], ['E3', 'soft', 0.27, -0.2], ['B3', 'soft', 0.12, 0.3], ['Cs4', 'flute', 0.12, -0.3], ['E4', 's', 0.06, 0.35], ['Gs4', 's', 0.03, -0.45]],
      whirl: { v: [['A1', 's', 0.5, 0], ['E2', 'soft', 0.378, 0.1], ['E2', 'grit', 0.054, -0.1], ['B2', 'soft', 0.162, -0.25], ['Fs3', 'soft', 0.108, 0.3], ['Cs4', 's', 0.054, -0.35]], pulse: [0.33, 0.35] },
      ...
      sea: { v: [['A1', 's', 0.5, 0], ['E2', 'soft', 0.405, 0.1], ['D3', 'soft', 0.189, -0.3], ['E3', 's', 0.135, 0.3], ['B3', 's', 0.068, -0.4]], pulse: [0.17, 0.35] },
  ...
  music('song', {
    ...
    pad: { lp: 1400, groups: {
      longing: [['A2', 's', 0.5, 0], ['E3', 'soft', 0.405, -0.2], ['C4', 'voice', 0.121, 0.3], ['D4', 'soft', 0.121, -0.3], ['G4', 's', 0.054, 0.4], ['B4', 's', 0.027, -0.45]],
      gazelle: [['A2', 's', 0.46, 0], ['E3', 'soft', 0.299, -0.15], ['B3', 's', 0.138, 0.3], ['Cs4', 'soft', 0.138, -0.3], ['Ds4', 's', 0.057, 0.35], ['Gs4', 's', 0.046, -0.4], ['Fs5', 's', 0.014, 0.5]],
      spring: [['A2', 's', 0.5, 0], ['E3', 'soft', 0.378, -0.2], ['Cs4', 'soft', 0.203, 0.3], ['E4', 'flute', 0.108, -0.3], ['Fs4', 's', 0.081, 0.4], ['A4', 's', 0.054, -0.45], ['Cs5', 's', 0.027, 0.5]],
      garden: { v: [['A2', 's', 0.5, 0], ['E3', 'soft', 0.351, -0.2], ['Gs3', 'soft', 0.121, 0.3], ['B3', 's', 0.135, -0.3], ['Cs4', 'voice', 0.135, 0.2], ['E4', 's', 0.081, -0.4]], pulse: [0.22, 0.2] },
      night: [['A1', 's', 0.5, 0], ['E2', 'soft', 0.347, 0.1], ['A2', 'soft', 0.124, -0.2], ['C3', 'soft', 0.223, 0.3], ['G3', 's', 0.074, -0.3], ['D4', 's', 0.05, 0.4]],
      procession: { v: [['A2', 's', 0.5, 0], ['E3', 'soft', 0.343, -0.15], ['A3', 't', 0.132, 0.25], ['D4', 'soft', 0.132, -0.3], ['E4', 's', 0.079, 0.35], ['G4', 's', 0.046, -0.4]], pulse: [1.6, 0.3] },
      flame: { v: [['A1', 's', 0.448, 0], ['E2', 'soft', 0.314, 0.1], ['A2', 'warm', 0.112, -0.2], ['Cs3', 'soft', 0.179, 0.3], ['E3', 'soft', 0.112, -0.3], ['B3', 's', 0.056, 0.35], ['Gs4', 's', 0.028, -0.4]], pulse: [0.3, 0.25] },
    } },
    mix: sgMix,
  ...
  music('twelve1', {
    ...
    pad: { lp: 1300, groups: {
      ...
      cords: [['A2', 's', 0.454, 0], ['E3', 'soft', 0.302, -0.15], ['Cs4', 'voice', 0.13, 0.3], ['E4', 's', 0.076, -0.35], ['Fs4', 'flute', 0.065, 0.4], ['A4', 's', 0.032, -0.45]],
      idol: [['A1', 's', 0.5, 0], ['E2', 'soft', 0.33, 0.1], ['A2', 'reed', 0.044, 0.2], ['Bb2', 'soft', 0.077, -0.35], ['D3', 'soft', 0.154, 0.3], ['G3', 's', 0.055, -0.3]],
      swarm: { v: [['A1', 's', 0.5, 0], ['E2', 'soft', 0.381, 0.1], ['Bb2', 'soft', 0.089, -0.35], ['C3', 'soft', 0.254, 0.3], ['E3', 't', 0.064, 0.4], ['F3', 's', 0.076, -0.3]], pulse: [6.2, 0.35] },
      ...
      justice: { v: [['A1', 's', 0.484, 0], ['E2', 'soft', 0.33, 0.1], ['A2', 'warm', 0.088, -0.2], ['D3', 'soft', 0.154, 0.3], ['E3', 'soft', 0.132, -0.3], ['G3', 's', 0.055, 0.35]], pulse: [0.42, 0.28] },
      storm: { v: [['A1', 's', 0.5, 0], ['E2', 'soft', 0.432, 0.1], ['B2', 'soft', 0.135, -0.3], ['C3', 'soft', 0.216, 0.3], ['F3', 's', 0.068, -0.35]], pulse: [0.2, 0.35] },
      harvest: [['A2', 's', 0.487, 0], ['E3', 'soft', 0.325, -0.2], ['A3', 'soft', 0.151, 0.25], ['A3', 'harp', 0.046, 0.1], ['Cs4', 'soft', 0.162, -0.3], ['E4', 's', 0.093, 0.35], ['B4', 's', 0.035, -0.45]],
      sea: { v: [['A2', 's', 0.5, 0], ['E3', 'soft', 0.351, -0.2], ['B3', 's', 0.156, 0.3], ['Cs4', 'soft', 0.156, -0.3], ['Gs4', 's', 0.065, 0.4], ['E5', 's', 0.026, -0.45]], pulse: [0.14, 0.22] },
    } },
    mix: taMix,
