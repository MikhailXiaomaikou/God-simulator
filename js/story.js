...
(function (GS) {
  ...
  const STAGES = [
    ...
    },
    {
      ...
      verse: [
        ...
        { text: '「至于地上的走兽和空中的飞鸟……<br>我将青草赐给它们作食物。」事就这样成了。', ref: '创世记 1:30', hold: 6 },
      ],
      apply(c) {
    ...
    },
    {
      ...
      verse: [
        ...
        { text: '因为在这日，神歇了他一切创造的工，就安息了。', ref: '创世记 2:3', hold: 7 },
      ],
      apply(c) {
  ...
  const BEHOLD = {
    ...
    cattle: { text: '牲畜，各从其类；神看着是好的。', ref: '创世记 1:25' },
    beast:  { text: '于是神造出野兽，各从其类。', ref: '创世记 1:25' },
    ...
    sun:    { text: '于是神造了两个大光，大的管昼，', ref: '创世记 1:16' },
    moon:   { text: '小的管夜，', ref: '创世记 1:16' },
