...
(function (GS) {
  ...
  GS.book.act({
    ...
    stages: [
      {
        kind: 'act', utter: '你们是世上的光', cmd: 'echo "登山宝训"', ref: '5:14',
        verse: [{ text: '你们是世上的光。城造在山上是不能隐藏的。', ref: '马太福音 5:14', hold: 7 }],
        apply(c) { if (!c.instant && GS.fx) GS.fx.ring(W.w * 0.7, W.h * 0.5, [255,  240,  210], Math.min(W.w, W.h) * 0.3, 2.2, 1.4); },
      },
    ],
  });
})(window.GS);
